 ...
 * Formula: (BTC_price_target / BTC_price_source)
 * This gives us how many target currency units we get for 1 source currency unit
 */
export function calculateBitcoinBasedRate(
  ...
  // Correct formula: target BTC price / source BTC price
  // This tells us how many target currency units we get for 1 source currency unit
  return targetBtcPrice / sourceBtcPrice;
}
